...
export default function DocumentFilter({ url }) {
    ...
    const formik = useFormik({
        ...
        onSubmit: (values) => {
            let urlValues = common.getDocumentFilter();
            urlValues.page = 1;
            urlValues.status = values.status || "";
            urlValues.documentType = values.documentType || "";
    ...
    useEffect(() => {
        ...
        formik.setFieldValue("documentType", urlValues?.documentType || "");
                            ...
                            <form onSubmit={formik.handleSubmit}>
                                ...
                                <div className="loginsinphone catemodal">
                                    ...
                                    <div className="filtercategory mb-3">
                                        ...
                                        <ErrorMessage formik={formik} name="documentType" />
                                    </div>
                                </div>
